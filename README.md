...
*Modelling Inductive Switching Transients in LiFePO₄ vs AGM — NGSpice Simulation*
...
![Inrush current waveform at motor start](images/scope/windlass-inrush-grey.jpg)
